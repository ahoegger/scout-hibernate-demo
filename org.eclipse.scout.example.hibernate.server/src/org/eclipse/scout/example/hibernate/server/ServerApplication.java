 ...
 * org.eclipse.equinox.http.jetty.context.path=/exampleHibernate
 ...
 * eclipse.product=org.eclipse.scout.example.hibernate.server.product
 */
public class ServerApplication implements IApplication{
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("exampleHibernate server initialized");
    return EXIT_OK;
  }
